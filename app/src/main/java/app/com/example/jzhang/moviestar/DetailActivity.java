    ...
    public static class DetailFragment extends Fragment {
        ...
        public View onCreateView(LayoutInflater inflater, ViewGroup container,
            ...
            if(intent != null && intent.hasExtra("myMovie")){
                MovieData movie = (MovieData)intent.getSerializableExtra("myMovie");
                ...
                ((TextView) rootView.findViewById(R.id.detail_overview))
                                               .setText(movie.getMovieOverview());
                ((TextView) rootView.findViewById(R.id.detail_rate))
                                               .setText(movie.getMovieRating());
                ((TextView) rootView.findViewById(R.id.detail_date))
                                               .setText(movie.getMovieDate());
                Picasso.with(getActivity()).load(movie.getMovieImg()).into(
